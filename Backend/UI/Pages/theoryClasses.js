...
exports.default = theoryClassesPage;
...
function theoryClassesPage(model, day) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return (0, base_1.default)(T.Generic.TheoryClasses, [
            [types_1.ButtonStyles.Primary, T.Generic.CreateNew, "add", `/new-theory-class/${day}`],
        ], (0, group_1.default)(T.Generic.TheoryClasses, "", (0, formInline_1.default)("/theory-classes", "GET", T.Generic.ClassDate, (0, input_1.default)(day, "date", "date")), "<hr>", (0, grid_1.default)(190, ...items)));
    });
}
