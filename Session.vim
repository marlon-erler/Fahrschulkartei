...
silent only
silent tabonly
cd ~/Documents/Code/Commercial/Fahrschulkartei
...
badd +1 Backend/Core/index.ts
badd +1 Backend/Core/headless.ts
badd +30 Backend/Model/model.ts
badd +1 Backend/Model/keys.ts
badd +1 Backend/Core/utility.ts
badd +1 Backend/Core/server.ts
badd +1 Backend/UI/base.ts
badd +5 Backend/UI/item.ts
badd +15 Backend/UI/Pages/schoolData.ts
badd +1 Backend/UI/grid.ts
badd +1 Frontend/static/styles/index.css
badd +79 Frontend/static/styles/layout.css
badd +26 Backend/UI/translations.ts
badd +10 Backend/UI/modelEntryLabel.js
badd +8 Backend/UI/modelEntryLabel.ts
badd +13 Backend/UI/Pages/pricingCharts.ts
badd +5 Backend/UI/modelItem.ts
badd +1 Backend/UI/sidebar.ts
badd +1 Frontend/static/styles/fonts/IBMPlexMono-Bold.ttf
badd +4 Frontend/static/styles/icons.css
argglobal
%argdel
$argadd Backend/UI/Pages/schoolData.ts
set stal=2
...
exe 'vert 3resize ' . ((&columns * 140 + 136) / 273)
argglobal
enew
...
wincmd w
argglobal
if bufexists(fnamemodify("Backend/Core/headless.ts", ":p")) | buffer Backend/Core/headless.ts | else | edit Backend/Core/headless.ts | endif
balt Backend/Core/index.ts
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> [c <Plug>(GitGutterPrevHunk)
nmap <buffer> \hp <Plug>(GitGutterPreviewHunk)
...
exe 'vert 2resize ' . ((&columns * 120 + 136) / 273)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 54 - ((24 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 54
...
silent! normal! zE
let &fdl = &fdl
let s:l = 56 - ((0 * winheight(0) + 12) / 24)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 56
...
wincmd w
argglobal
if bufexists(fnamemodify("Backend/Core/utility.ts", ":p")) | buffer Backend/Core/utility.ts | else | edit Backend/Core/utility.ts | endif
...
silent! normal! zE
let &fdl = &fdl
let s:l = 39 - ((5 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 39
...
exe 'vert 5resize ' . ((&columns * 120 + 136) / 273)
argglobal
enew
...
wincmd w
argglobal
if bufexists(fnamemodify("Backend/UI/modelItem.ts", ":p")) | buffer Backend/UI/modelItem.ts | else | edit Backend/UI/modelItem.ts | endif
balt Backend/UI/modelEntryLabel.ts
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> [c <Plug>(GitGutterPrevHunk)
nmap <buffer> \hp <Plug>(GitGutterPreviewHunk)
...
wincmd w
argglobal
if bufexists(fnamemodify("Backend/UI/modelEntryLabel.ts", ":p")) | buffer Backend/UI/modelEntryLabel.ts | else | edit Backend/UI/modelEntryLabel.ts | endif
balt Backend/Core/server.ts
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> [c <Plug>(GitGutterPrevHunk)
...
wincmd w
argglobal
if bufexists(fnamemodify("Backend/UI/sidebar.ts", ":p")) | buffer Backend/UI/sidebar.ts | else | edit Backend/UI/sidebar.ts | endif
balt Backend/UI/item.ts
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> [c <Plug>(GitGutterPrevHunk)
...
balt Frontend/static/styles/layout.css
let s:cpo_save=&cpo
set cpo&vim
nnoremap <buffer> <silent> <NL> :call nerdtree#ui_glue#invokeKeyMap("<C-j>")
nnoremap <buffer> <silent>  :call nerdtree#ui_glue#invokeKeyMap("<C-k>")
...
wincmd w
argglobal
balt Frontend/static/styles/icons.css
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> [c <Plug>(GitGutterPrevHunk)
nmap <buffer> \hp <Plug>(GitGutterPreviewHunk)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 83 - ((36 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 83
...
silent! normal! zE
let &fdl = &fdl
let s:l = 30 - ((22 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 30
...
wincmd w
argglobal
if bufexists(fnamemodify("Backend/Model/keys.ts", ":p")) | buffer Backend/Model/keys.ts | else | edit Backend/Model/keys.ts | endif
balt Backend/Model/model.ts
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> [c <Plug>(GitGutterPrevHunk)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 28 - ((22 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 28
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 32 + 136) / 273)
exe 'vert 2resize ' . ((&columns * 240 + 136) / 273)
argglobal
enew
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 41 + 136) / 273)
exe 'vert 2resize ' . ((&columns * 116 + 136) / 273)
exe 'vert 3resize ' . ((&columns * 114 + 136) / 273)
argglobal
enew
...
wincmd w
argglobal
balt Backend/UI/translations.ts
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> [c <Plug>(GitGutterPrevHunk)
nmap <buffer> \hp <Plug>(GitGutterPreviewHunk)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 20 - ((10 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 20
