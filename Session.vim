...
badd +19 Backend/Model/model.ts
badd +18 Backend/Model/keys.ts
argglobal
%argdel
...
silent! normal! zE
let &fdl = &fdl
let s:l = 63 - ((31 * winheight(0) + 28) / 56)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 95 - ((12 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 95
...
silent! normal! zE
let &fdl = &fdl
let s:l = 77 - ((19 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 77
