...
exe 'vert 2resize ' . ((&columns * 71 + 87) / 175)
exe '3resize ' . ((&lines * 26 + 28) / 56)
exe 'vert 3resize ' . ((&columns * 71 + 87) / 175)
exe 'vert 4resize ' . ((&columns * 71 + 87) / 175)
argglobal
enew
...
silent! normal! zE
let &fdl = &fdl
let s:l = 20 - ((9 * winheight(0) + 13) / 26)
...
set winwidth=1
exe 'vert 1resize ' . ((&columns * 31 + 87) / 175)
exe 'vert 2resize ' . ((&columns * 125 + 87) / 175)
exe 'vert 3resize ' . ((&columns * 15 + 87) / 175)
exe 'vert 4resize ' . ((&columns * 1 + 87) / 175)
argglobal
enew
...
set winwidth=1
exe 'vert 1resize ' . ((&columns * 31 + 87) / 175)
exe 'vert 2resize ' . ((&columns * 127 + 87) / 175)
exe 'vert 3resize ' . ((&columns * 15 + 87) / 175)
argglobal
enew
