...
badd +1 package.json
badd +13 electron-builder.yml
badd +1 dist/builder-effective-config.yaml
badd +1 .gitignore
badd +1 Core/index.ts
badd +1 Core/server.ts
badd +1 Backend/Core/index.js
badd +22 Backend/Core/index.ts
badd +1 Backend/Core/server.ts
badd +10 Backend/tsconfig.json
badd +9 Backend/Model/drivingSchool.ts
badd +69 Backend/Model/keys.ts
badd +23 Backend/Model/model.ts
badd +3 Backend/Core/headless.ts
badd +1 Backend/Core/server.js
badd +0 Backend/Core/utility.ts
badd +1 test.ts
argglobal
%argdel
$argadd package.json
...
exe 'vert 2resize ' . ((&columns * 63 + 136) / 272)
exe '3resize ' . ((&lines * 26 + 28) / 57)
exe 'vert 3resize ' . ((&columns * 63 + 136) / 272)
exe '4resize ' . ((&lines * 53 + 28) / 57)
exe 'vert 4resize ' . ((&columns * 63 + 136) / 272)
exe '5resize ' . ((&lines * 53 + 28) / 57)
exe 'vert 5resize ' . ((&columns * 15 + 136) / 272)
argglobal
enew
...
set winwidth=1
exe 'vert 1resize ' . ((&columns * 31 + 136) / 272)
exe 'vert 2resize ' . ((&columns * 112 + 136) / 272)
exe 'vert 3resize ' . ((&columns * 111 + 136) / 272)
exe 'vert 4resize ' . ((&columns * 15 + 136) / 272)
argglobal
enew
...
set winwidth=1
exe 'vert 1resize ' . ((&columns * 31 + 136) / 272)
exe 'vert 2resize ' . ((&columns * 224 + 136) / 272)
exe 'vert 3resize ' . ((&columns * 15 + 136) / 272)
argglobal
enew
