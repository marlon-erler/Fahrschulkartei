...
badd +46 Backend/Core/server.ts
badd +134 Backend/Model/model.ts
...
silent! normal! zE
let &fdl = &fdl
let s:l = 79 - ((24 * winheight(0) + 28) / 56)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 99 - ((6 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 99
...
silent! normal! zE
let &fdl = &fdl
let s:l = 29 - ((0 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 29
...
silent! normal! zE
let &fdl = &fdl
let s:l = 136 - ((28 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 136
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 43 + 135) / 271)
exe 'vert 2resize ' . ((&columns * 61 + 135) / 271)
exe 'vert 3resize ' . ((&columns * 165 + 135) / 271)
argglobal
enew
...
silent! normal! zE
let &fdl = &fdl
let s:l = 62 - ((30 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 62
...
silent! normal! zE
let &fdl = &fdl
let s:l = 134 - ((22 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 134
...
set winwidth=1
exe 'vert 1resize ' . ((&columns * 43 + 135) / 271)
exe 'vert 2resize ' . ((&columns * 227 + 135) / 271)
argglobal
enew
