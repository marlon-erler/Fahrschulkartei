...
badd +0 Backend/UI/Pages/schoolData.ts
badd +0 Backend/UI/grid.ts
badd +0 Frontend/static/styles/index.css
argglobal
%argdel
...
silent! normal! zE
let &fdl = &fdl
let s:l = 26 - ((4 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 26
...
silent! normal! zE
let &fdl = &fdl
let s:l = 488 - ((21 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 488
