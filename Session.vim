...
badd +20 Backend/UI/base.ts
badd +18 Backend/UI/sidebar.ts
badd +1 Backend/Core/types.ts
badd +13 Backend/UI/Pages/pricingChart.ts
badd +169 Backend/Model/model.ts
badd +15 Backend/UI/Pages/schoolData.ts
badd +14 Backend/UI/modelEntryLabel.ts
badd +1 Backend/Core/server.ts
badd +1 Frontend/static/styles/layout.css
badd +27 Backend/UI/Pages/students.ts
badd +12 Backend/Model/model.js
badd +1 Backend/UI/translations.ts
badd +1 Backend/UI/Pages/student.ts
badd +6 Backend/Core/headless.ts
badd +8 Backend/Model/keys.ts
argglobal
%argdel
$argadd Backend/Core/utility.ts
set stal=2
...
exe 'vert 3resize ' . ((&columns * 86 + 119) / 239)
argglobal
enew
...
silent! normal! zE
let &fdl = &fdl
let s:l = 41 - ((12 * winheight(0) + 21) / 42)
...
wincmd w
argglobal
if bufexists(fnamemodify("Backend/Core/types.ts", ":p")) | buffer Backend/Core/types.ts | else | edit Backend/Core/types.ts | endif
...
exe 'vert 3resize ' . ((&columns * 86 + 119) / 239)
tabnext
edit Backend/UI/Pages/student.ts
let s:save_splitbelow = &splitbelow
let s:save_splitright = &splitright
set splitbelow splitright
wincmd _ | wincmd |
...
wincmd w
argglobal
balt Backend/UI/Pages/students.ts
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> [c <Plug>(GitGutterPrevHunk)
nmap <buffer> \hp <Plug>(GitGutterPreviewHunk)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 81 - ((24 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 81
...
balt Backend/UI/Pages/pricingChart.ts
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> [c <Plug>(GitGutterPrevHunk)
nmap <buffer> \hp <Plug>(GitGutterPreviewHunk)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 123 - ((16 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 123
...
silent! normal! zE
let &fdl = &fdl
let s:l = 169 - ((18 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 169
