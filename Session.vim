...
exe 'vert 2resize ' . ((&columns * 63 + 87) / 175)
exe '3resize ' . ((&lines * 26 + 28) / 56)
exe 'vert 3resize ' . ((&columns * 63 + 87) / 175)
exe 'vert 4resize ' . ((&columns * 63 + 87) / 175)
exe 'vert 5resize ' . ((&columns * 15 + 87) / 175)
argglobal
enew
