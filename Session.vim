...
exe 'vert 2resize ' . ((&columns * 41 + 135) / 271)
exe '3resize ' . ((&lines * 33 + 26) / 53)
exe 'vert 3resize ' . ((&columns * 41 + 135) / 271)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 63 - ((29 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 63
...
silent! normal! zE
let &fdl = &fdl
let s:l = 64 - ((28 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 64
...
exe 'vert 2resize ' . ((&columns * 80 + 135) / 271)
exe '3resize ' . ((&lines * 43 + 26) / 53)
exe 'vert 3resize ' . ((&columns * 80 + 135) / 271)
argglobal
enew
...
silent! normal! zE
let &fdl = &fdl
let s:l = 27 - ((5 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 27
